...
jQuery( function($) {
	tinyMCE.init({
		...
		plugins: [
	        ...
	        "insertdatetime media table contextmenu paste code image_mykees"
	    ],
		menubar : false,
		...
		past_remove_styles: true,
		paste_remove_spans : true,
		paste_strip_class_attribute : "all",
		image_mykees_explorer : $('#explorer').val(),
		image_mykees_edit : $('#explorer').val(),
		relative_urls : false,
		content_css: $('#explorer').data('css'),
	});
});
